...
//    the flat partition ordinal in the high 20 bits, gl_PrimitiveID (the triangle ordinal within the draw) in the low 12 bits. A later resolve
...
// primitive and shifts down 20 for the partition. This pack layout MUST match VisibilityRaster.frag's consumer and the resolve.
