...
#pragma once
#ifndef FRONTIER_GRAPHICS_SCENE_REFERENCEGEOMETRYASSET_H
#define FRONTIER_GRAPHICS_SCENE_REFERENCEGEOMETRYASSET_H
...
// "indices" (triCount*3 uint). TextureCoordinate is left zero (the reference geometry carries none). Returns false with Result emptied on a missing
...
bool LoadReferenceGeometryAsset(const char* FilePath, RenderVertexStream& Result);
