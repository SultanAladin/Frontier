/*============================================================================================================================================
                                                              POLYGONINSET.H
============================================================================================================================================*/
// ðŸ§© The Blender-standard face-inset kernel for the authoring PolygonCluster: it clones the selected face set into a shrunk inner
...
//    TWO interactive scalars â€” Thickness (each boundary vertex slides inward along its in-plane corner bisector) and Depth (the
//    whole cap rides along the region / face normal) â€” reusing the viewport's modal-drag path exactly as extrude does. Two
...
#pragma once
#ifndef FRONTIER_AUTHORING_POLYGONAUTHORING_OPERATIONS_INSET_POLYGONINSET_H
#define FRONTIER_AUTHORING_POLYGONAUTHORING_OPERATIONS_INSET_POLYGONINSET_H
...
struct PolygonCluster;   // ðŸ“ forward-declared â€” the kernel mutates its face stream + positions; the .cpp pulls the full header.
struct AdjacencyIndex;   // ðŸ“ forward-declared â€” the kernel reads loops / normals / centres / edge incidence over the BASE topology only.

//------------------------------------------------------------------------------------------------------------------------
//                                                          ENUMERATIONS
//------------------------------------------------------------------------------------------------------------------------

// ðŸ“ The inset variant, taken from the toolbar's Individual toggle. `.Category` suffix per the naming skill (replaces `Kind`).
...
// ðŸ“ One appended cap vertex and the two axes it slides along while the caller drives the interactive offset. InwardDirection
...
// ðŸ“ The whole outcome of a zero-offset inset: what topology was appended and how to drive the live offset. CapFaces / CapVertices
...
// false, and false is returned. The caller must re-run ResolveAdjacencyIndex on the mutated Target afterwards â€” the passed-in
...
#endif   // FRONTIER_AUTHORING_POLYGONAUTHORING_OPERATIONS_INSET_POLYGONINSET_H
