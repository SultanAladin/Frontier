/*============================================================================================================================================
                                                            SUBDIVIDESIMPLE.H
============================================================================================================================================*/
// ðŸ§© One level of SIMPLE (linear) subdivision on an indexed-face polygon: every face of n corners is split into n quads using its
//    edge midpoints and its centroid, WITHOUT moving any point (unlike Catmull-Clark, which also smooths). It is the plainest
//    subdivision scheme because it needs no limit-surface math â€” pure connectivity refinement on the flat (Positions,
//    FaceVertexIndices, FaceVertexCounts) arrays the modifier stack extracts from the base PolygonCluster.
// ðŸ“ Midpoints are shared between adjacent faces (deduplicated on the unordered endpoint-slot pair), so the refined polygon stays
//    watertight â€” two faces sharing an edge reference the same midpoint vertex, exactly as the unsubdivided edge was shared.

#pragma once
#ifndef FRONTIER_AUTHORING_POLYGONAUTHORING_MODIFIER_SUBDIVIDESIMPLE_H
#define FRONTIER_AUTHORING_POLYGONAUTHORING_MODIFIER_SUBDIVIDESIMPLE_H
...
// each face's corner indices in winding order. The outputs are the refined polygon in the same format â€” original points first,
...
#endif   // FRONTIER_AUTHORING_POLYGONAUTHORING_MODIFIER_SUBDIVIDESIMPLE_H
