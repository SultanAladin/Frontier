/*============================================================================================================================================
                                                             MODIFIERSTACK.H
============================================================================================================================================*/
// ðŸ§© A non-destructive ordered list of polygon modifiers owned per object. The base PolygonCluster is never mutated; the stack is
...
//    real geometry today â€” SimpleScheme (linear split, SubdivideSimpleLevel) and CatmullClarkScheme (smooth quad limit surface,
...
// ðŸ“ Flat-array port of the retired topology-typed stack: the live model is a flat PolygonCluster (Positions + FaceVertexIndices +
//    FaceVertexCounts), so evaluation runs the flat subdivision kernels directly â€” no half-edge extract / rebuild. Only the
...
#pragma once
#ifndef FRONTIER_AUTHORING_POLYGONAUTHORING_MODIFIER_MODIFIERSTACK_H
#define FRONTIER_AUTHORING_POLYGONAUTHORING_MODIFIER_MODIFIERSTACK_H
...
// ðŸ“ The subdivision schemes the UI offers. SimpleScheme and CatmullClarkScheme refine real geometry today; Loop and Doo-Sabin
...
// ðŸ“ Which operation an entry performs. Subdivision honours its Scheme; Bevel / Chamfer are stubs carrying their settings.
...
// ðŸ“ Direction to move an entry within the stack (one slot per step) â€” the reorder buttons the Properties UI exposes.
...
// ðŸ“ One modifier in the stack: its category + the settings for every category (only the active category's fields are read, so
...
//    hard creases) â€” the "more than Blender" levers exposed per entry.
...
// ðŸ“ The ordered stack for one object. Entries evaluate front-to-back. NextIdentifier mints stable ids so a deleted entry's id
...
#endif   // FRONTIER_AUTHORING_POLYGONAUTHORING_MODIFIER_MODIFIERSTACK_H
