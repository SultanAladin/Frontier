/*============================================================================================================================================
                                                              POLYGONBEVEL.H
============================================================================================================================================*/
// 🧩 The vertex-centric bevel / chamfer kernel for the authoring PolygonCluster, after Blender's bmesh_bevel but self-healing where
...
#pragma once
#ifndef FRONTIER_AUTHORING_MODELING_BEVEL_POLYGONBEVEL_H
#define FRONTIER_AUTHORING_MODELING_BEVEL_POLYGONBEVEL_H
...
struct PolygonCluster;   // 📝 forward-declared — the kernel rebuilds its face stream + positions; the .cpp pulls the full header.
struct AdjacencyIndex;   // 📝 forward-declared — the clamp evaluator reads loops / normals / centres over the BASE topology only.

//------------------------------------------------------------------------------------------------------------------------
//                                                          ENUMERATIONS
//------------------------------------------------------------------------------------------------------------------------

// 📝 Which component the bevel acts on, taken from the active selection mode. `.Category` suffix per the naming skill (replaces `Kind`).
...
// 📝 The profile the rounded bevel sweeps between the two edge-offset points. Roundness drives a superellipse exponent:
...
// 📝 The whole outcome of a bevel: what topology the beveled region now owns (the follow-on selection) and the safe max width the
...
// ResolveAdjacencyIndex on the mutated Target afterwards — the passed-in BaseAdjacency is now stale.
...
#endif   // FRONTIER_AUTHORING_MODELING_BEVEL_POLYGONBEVEL_H
