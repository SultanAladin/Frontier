/*============================================================================================================================================
                                                             SELECTIONMODE.H
============================================================================================================================================*/
// 🧩 Which category of polygon component the active selection addresses — vertex, edge, or face. This is the one global modelling
...
// 📝 An unscoped enum so the three mode names read bare at call sites (FaceMode), matching the project's plain-data style; the
//    pool dispatch that consumes it lives in ComponentSelection.

#pragma once
#ifndef FRONTIER_AUTHORING_MODELING_SELECTION_SELECTIONMODE_H
#define FRONTIER_AUTHORING_MODELING_SELECTION_SELECTIONMODE_H
...
// 📝 What a selection operates over. ObjectMode is the whole-object axis (no component pool — it drives the object-select bit and
...
#endif   // FRONTIER_AUTHORING_MODELING_SELECTION_SELECTIONMODE_H
