/*============================================================================================================================================
                                                              VERTEXFIELD.H
============================================================================================================================================*/
// 🧩 Structure-of-arrays CPU authoring vertex attributes (double precision). Position is mandatory; Normal / TextureCoordinate /
...
#pragma once
#ifndef FRONTIER_AUTHORING_MODELING_GEOMETRY_VERTEXFIELD_H
#define FRONTIER_AUTHORING_MODELING_GEOMETRY_VERTEXFIELD_H
...
// 📝 Parallel attribute arrays indexed by a single vertex index. An empty optional array means that attribute is absent;
...
// Returns false if VertexIndex is out of range. (Approved verb: Refresh — Assign/Set are forbidden.)
