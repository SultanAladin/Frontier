/*============================================================================================================================================
                                                             TRIANGLEORIGIN.H
============================================================================================================================================*/
// 🧩 The provenance map that survives triangulation: every display triangle records the editable face it came from and the
//    three source face-corner references it was triangulated across. This is what lets a CPU (or later GPU) pick — a triangle
//    ordinal plus a barycentric coordinate — resolve back to a face / edge / vertex without reverse-searching the topology.
...
//
// 📝 This is the CLUSTER-native provenance: SourceFace is the PolygonCluster face ordinal (index into FaceVertexCounts) and
...
#pragma once
#ifndef FRONTIER_AUTHORING_MODELING_GEOMETRY_DISPLAY_TRIANGLEORIGIN_H
#define FRONTIER_AUTHORING_MODELING_GEOMETRY_DISPLAY_TRIANGLEORIGIN_H
...
// 📝 Sentinel for "no source assigned" — a default-constructed TriangleOrigin (out-of-range query result) reads as this on
...
// 📝 One display triangle's provenance. SourceFace is the cluster face ordinal it tessellates part of; SourceCorner[0..2] are
...
// 📝 The display mirror's whole output: the interleaved GPU stream (the renderer's single presentation contract, reused from
//    PolygonCluster.h — never redefined here) plus the parallel provenance map. TriangleOrigins.size() always equals
//    Indices.size() / 3; one origin per emitted triangle. Both are regenerated together by ConstructDisplayPolygons; neither is
//    ever read back into the authoring cluster (anti-fragility §3.3).
...
// Retrieve the provenance of display triangle TriangleOrdinal (0-based, NOT an index offset — triangle t owns indices
...
#endif   // FRONTIER_AUTHORING_MODELING_GEOMETRY_DISPLAY_TRIANGLEORIGIN_H
