/*============================================================================================================================================
                                                             FACETRIANGULATION.H
============================================================================================================================================*/
// 🧩 One shared face-to-triangle policy for every cluster derivation. A triangle or quad is fanned (fast, always correct for
...
//    winding order — the caller maps each local index onto its own flat corner cursor, vertex layout, and provenance record,
//    so this unit never touches the GPU stream or TriangleOrigin directly.

#pragma once
#ifndef FRONTIER_AUTHORING_MODELING_GEOMETRY_FACETRIANGULATION_H
#define FRONTIER_AUTHORING_MODELING_GEOMETRY_FACETRIANGULATION_H
...
// 📝 Triangulate one face from its corner positions (world cm, in face order). Returns a flat triplet run of LOCAL corner
//    indices [0, CornerPositions.size()) — length is a multiple of three, (Count - 2) triangles for a well-formed face.
...
#endif   // FRONTIER_AUTHORING_MODELING_GEOMETRY_FACETRIANGULATION_H
