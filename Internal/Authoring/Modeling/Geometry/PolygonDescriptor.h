/*============================================================================================================================================
                                                             POLYGONDESCRIPTOR.H
============================================================================================================================================*/
// 🧩 Lightweight metadata for a PolygonCluster: stable identity, element counts, the axis-aligned bounding extent, and which optional
//    vertex attributes are present. Carries no heavy geometry — it is the cheap-to-copy summary a Scene / Outliner reads.

#pragma once
#ifndef FRONTIER_AUTHORING_MODELING_GEOMETRY_POLYGONDESCRIPTOR_H
#define FRONTIER_AUTHORING_MODELING_GEOMETRY_POLYGONDESCRIPTOR_H
...
// 📝 Opaque, stable polygon identity. A plain integer alias for now; this is the seam where a MicroUtils generational handle
//    (IdentifierAllocation) drops in later, so callers reference identity by type, never by raw array index (anti-fragility §3.2).
...
// 📝 Axis-aligned bounding extent in authoring space. An empty polygon yields MinimumCorner > MaximumCorner (degenerate),
...
// 📝 Cheap summary of a PolygonCluster. Counts and bounds are derived (EvaluatePolygonDescriptor in PolygonCluster.h refreshes them); the booleans
