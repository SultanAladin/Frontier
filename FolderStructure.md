...
│   │   │   ├── TokenIssuer.{h,cpp}                 // ★ canonical
│   │   │   └── TokenAuthentication.{h,cpp}         // ★ canonical
│   │   │
...
│   │   │   └── Build.bat
│   │   │
│   │   ├── Audio/                                  // shared audio service
│   │   │   ├── AudioExtension.{h,cpp}              // 🟢 device open, mix graph, per-cycle advance
...
│   │   │   ├── RecordStore.{h,cpp}               // dense store   (VacancyTable/TokenIssuer ← MicroUtils)
│   │   │   ├── RecordToken.h                     // identity (uses MicroUtils TokenIssuer + TokenAuthentication)
│   │   │   └── AdjacencyTable.{h,cpp}            // connectivity store
│   │   │
...
│   │   ├── InputBackend/  .gitkeep                 // ← retired scaffold (raw OS capture → EngineContext/Input)
│   │   └── Build.bat  README.md
│   │
...
| 1b | **Platform/** | Windowing · Concurrency · Storage · InputBackend |
