@echo off
REM ============================================================================
REM  TextureBake\Build.bat - build TextureBake.exe: a standalone launcher for the single TextureBake workspace. A native Vulkan
