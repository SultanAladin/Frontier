@echo off
REM ============================================================================
REM  ChannelPropertyValidation\Build.bat - build ChannelPropertyValidation.exe: a
REM  standalone Vulkan validation host for the channel slide of the paint-surface
REM  inspector, ported from Documentation\Prototypes\ChannelPropertyPanel.html.
REM  Opens a native Vulkan window + ImGui interface, resolves the shared theme,
REM  and drives ConstructChannelPropertyPanel each frame until the window closes.
REM
...
REM  via their own Build.bat, then compiles its own units (slot table + panel +
...
REM --- Compile this app's own units (slot table + panel + host) ----------------
