@echo off
REM ============================================================================
REM  ModellingToolValidation\Build.bat - build ModellingToolValidation.exe: a
REM  standalone Vulkan validation host for the two-slide modelling tool card
REM  ported from Documentation\Prototypes\ModellingToolMenu.html. Opens one native
