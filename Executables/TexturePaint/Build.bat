@echo off
REM ============================================================================
REM  TexturePaint\Build.bat - build TexturePaint.exe: a standalone launcher for the single TexturePaint workspace. A native Vulkan
